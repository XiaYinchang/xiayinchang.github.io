...
SecurityGroupId: 190219
ImageId: uimage-h2agy0
GPU: 1
CPU: 4
Memory: 8192
Disks[0][IsBoot]: true
...
Disks[0][Encrypted]: false
Disks[1][IsBoot]: false
Disks[1][Type]: CLOUD_SSD
Disks[1][Size]: 20
Disks[1][BackupType]: NONE
Disks[1][Encrypted]: false
...
GpuType: P40
LoginMode: Password
Password: dWs4cy1yMDB0bWU=
Name: UHost
Tag: Default
UserData: 
Disks.N.CouponId[0][IsBoot]: false
Disks.N.CouponId[0][Type]: CLOUD_SSD
Disks.N.CouponId[0][Size]: 20
Disks.N.CouponId[0][BackupType]: NONE
Disks.N.CouponId[0][Encrypted]: false
Action: CreateUHostInstance
_user: yinchang.xia@ucloud.cn
_timestamp: 1584073504042
```
返回结果：
```
{"RetCode":8834,"Message":"Cannot find target set info"}
```
